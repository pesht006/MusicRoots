  ...
  return (
    <div className="page" style={{ maxWidth: 760 }}>
      ...
      <div className="card" style={{ marginTop: 14 }}>
        ...
        <p className="muted">
          Любой может предложить новую связь, добавить источник, сообщить об ошибке или
          предложить исправление. Все предложения проходят модерацию перед публикацией.
        </p>
      </div>
    </div>
  );
